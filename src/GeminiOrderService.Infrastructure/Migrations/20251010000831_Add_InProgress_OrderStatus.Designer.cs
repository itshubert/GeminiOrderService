...
namespace GeminiOrderService.Infrastructure.Migrations
{
    ...
    [Migration("20251010000831_Add_InProgress_OrderStatus")]
    partial class Add_InProgress_OrderStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GeminiOrderService.Domain.Orders.Order", b =>
                {
                    ...
                    b.ToTable("Orders", null, t =>
                        {
                            t.HasCheckConstraint("CK_Orders_Status", "\"Status\" IN ('Pending', 'InProgress', 'Confirmed', 'Shipped', 'Delivered', 'Cancelled')");
                        });
                });
